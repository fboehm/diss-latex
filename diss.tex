...
\caption{Cholic acid chemical structure. From Wikipedia, \url{https://upload.wikimedia.org/wikipedia/commons/2/21/Chols\%C3\%A4ure.svg}.}\label{fig:cholic-structure}
\end{figure}
...
The scatter plot of plasma cholic acid levels and \emph{Turicibacter} abundance levels demonstrates little correlation between the two traits (Pearson correlation coefficient = ). xx of yy points have the smallest \emph{Turicibacter} abundance level. \emph{Turicibacter} was unobserved in these mice.
