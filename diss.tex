...
We discuss inference methods for genotype probabilities in Appendix~\ref{sec:appendix-hmm}.
...
\chapter{Molecular biology primer}


\chapter{Statistical inference primer}
