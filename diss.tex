...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in create.par(100, c(1, 2)): could not find function "{}create.par"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cross(f1, f1, m = 10, obl = TRUE): could not find function "{}cross"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in 2:ncol(f2p): argument of length 0}}\end{kframe}\begin{figure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in 2:ncol(f2m): argument of length 0}}\end{kframe}\begin{figure}
...
markers are ``missing'' because they aren't explicitly measured. \todo[inline]{insert Karls figure showing inter-marker position \& only marker genotypes}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in create.par(100, c(2 * i - 1, 2 * i)): could not find function "{}create.par"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'f2a' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'f2a' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ncol(temp): object 'temp' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'f2a' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ncol(temp): object 'temp' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'f2b' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'f3a' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'f3b' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'f4a' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'f4b' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'fa' not found}}\end{kframe}\begin{figure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'fa' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ncol(fa\$mat): object 'fa' not found}}\end{kframe}
\end{knitrout}
