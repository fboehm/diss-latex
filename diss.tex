...
with. The F$_1$ subjects mate with the specified founder line (A in Figure~\ref{fig:backcross}) to create generation ``BC'' subjects. Generation ``BC'' subjects are then genotyped and phenotyped for QTL mapping. 
