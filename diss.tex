...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in parent\$mat[1, ncol(parent\$mat)]: incorrect number of dimensions}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in parent\$mat[1, ncol(parent\$mat)]: incorrect number of dimensions}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in parent\$mat[1, ncol(parent\$mat)]: incorrect number of dimensions}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in parent\$mat[1, ncol(parent\$mat)]: incorrect number of dimensions}}\end{kframe}\begin{figure}
\includegraphics[width=\maxwidth]{figure/do-1} \caption[Diversity outbred mouse genomes are a highly heterozygous mixture of eight founder genomes]{Diversity outbred mouse genomes are a highly heterozygous mixture of eight founder genomes.}\label{fig:do}
\end{figure}
