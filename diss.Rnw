...
In Chapter 3, we illustrated its use in three vignettes.
...
From this analysis, I learned that the two traits shared a pleiotropic QTL and, thus,
it was reasonable to conduct further causal modeling studies for these two traits.
