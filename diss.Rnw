...
<<pleiotropy-2traits, fig.height = 4, fig.width = 6.5, out.width = "\\textwidth", fig.cap = "One pleiotropic QTL. Figure after code from https://github.com/kbroman/QTLFigs repository">>=
...
<<separate-2traits, fig.height = 4, fig.width = 6.5, out.width = "\\textwidth", fig.cap = "Two separate QTL. Figure after code from https://github.com/kbroman/QTLFigs repository">>=
bgcolor <- brocolors("bg")
iArrows <- igraph:::igraph.Arrows
