...
#lightblue <- "blue"
#pink <- "red"
lightblue <- brocolors("crayons")["Cerulean"]
...
from a mating design with $n$ genetically distinct founder lines \citep{haldane1931inbreeding,bailey1971recombinant,crow2007haldane}. The Collaborative 
...
founders' DNA. \todo[inline]{add figure for one mouse's DNA?? like figure 5A in Svenson et al. 2012}
With each new generation, the Diversity Outbred mouse genomes are shuffled
in smaller and smaller chunks.
The smaller DNA chunk sizes in later generations correspond to greater QTL mapping resolution.
...
\footnote{Published at \url{https://www.biorxiv.org/content/10.1101/550939v1}.}Complex trait studies in multiparental populations present new
