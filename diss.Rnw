...
\includegraphics{testing-pleiotropy-vs-separate-qtl_files/figure-latex/1d-lod-plots-1.pdf}
...
\includegraphics{testing-pleiotropy-vs-separate-qtl_files/figure-latex/profile-plot-1.pdf}
