...
<<do, fig.cap = "Diversity outbred mouse genomes are a highly heterozygous mixture of eight founder genomes.", eval = FALSE>>=
##############################
# HS
##############################
bgcolor <- "white"
...
founders' DNA. Figure~\ref{fig:svenson} (Figure 5 in 
\citet{svenson2012high})presents a Diversity Outbred mouse genome 
from the fourth outbreeding generation. DNA from each founder 
line is color-coded. 
